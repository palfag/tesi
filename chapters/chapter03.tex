...
\begin{itemize}
  ...
  \begin{table}[htp]
    ...
    vi sono altre soluzioni DLP gratuite \cite{DLP_open}. OpenDLP può essere scaricato dal sito: 
    ...
    \begin{figure}
        \centering
        \fbox{\includegraphics[width=.7\textwidth, height=.6\textheight, keepaspectratio]{2017-gartner-magic-quadrant-for-enterprise-data-loss-prevention-new.png}}
