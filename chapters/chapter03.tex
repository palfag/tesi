...
Per l'implementazione del progetto sono state utilizzate diverse tecnologie:
    ...
    maggiori garanzie per quanto riguarda la sicurezza. 
    ...
    degli script. A differenza di linguaggi come il C e Java è un linguaggio interpretato e non compilato. 
    ...
    Inoltre è gratuito e open source, utilizzabile da chiunque.
    ...
    ma anche utilizzando variabili, funzioni e strutture di controllo di flusso.
    
    \subsection{Apache Tika}
    Apache tika è un tool per l’analisi dei contenuti, permette di estrarre il testo da migliaia di tipi di file diversi. 
    ...
    Oracle VM VirtualBox è un software gratuito e open source per l'esecuzione di macchine virtuali. 
