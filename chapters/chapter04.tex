...
\section{Analisi}
  ...
  Il glossario mostrato nella tabella \ref{Glossario} è una raccolta di termini significativi utilizzati 
  nel progetto, e le relative definizioni.
  \begin{table}[!b]
      \centering
      \resizebox{\textwidth}{!}{%
      \begin{tabular}{|l|l|}
      ...
      \subsection{Analisi dei requisiti}
        ...
        \begin{table}[htp]
            ...
            \multicolumn{1}{|l|}{Nome}                             & \multicolumn{1}{l|}{Identificazione di contenuti riservati} \\ \hline
            \rowcolor[HTML]{EFEFEF} 
            \multicolumn{1}{|l|}{\cellcolor[HTML]{EFEFEF}Definizione} &
