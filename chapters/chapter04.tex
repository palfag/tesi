...
\section{Analisi}
  ...
  \begin{table}[!b]
      ...
      Email &
        \begin{tabular}[c]{@{}l@{}}Oggetto che va monitorato e \\ ispezionato dalla soluzione DLP.\\ In generale una email contiene:\\ -  Mittente;\\ -  Destinatario;\\ -  Oggetto;\\ -  Corpo;\\ -  Allegato (opzionale).\\ \\ I primi due attributi sono\\ oggetto di analisi del contesto, \\ mentre gli ultimi tre vengono ispezionati \\ durante l’analisi del contenuto.\end{tabular} \\ \hline
      Dati riservati &
